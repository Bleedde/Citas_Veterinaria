...
export const Formulario = ({setPacientes, pacientes, paciente, setPaciente}) => {
  ...
  return (
    ...
    <div className='md:w-1/2 lg:w-2/5 mx-5'>
      ...
      <p className='text-xl mt-6 text-center mb-10'>
        Añade Pacientes y {''}
        <span className='text-indigo-600 font-bold '>Administralos</span>
      </p>

      <form action="" onSubmit={handleSubmit} className='bg-white shadow-md rounded-lg py-10 px-5'>
        ...
        <div className='mb-5'>
          ...
          <textarea className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md' id="sintomas" placeholder='Describe los Sintomas' value={sintomas}
